...
// Connect to the WiFi
const char* ssid = "Bagus Supriyanto_plus";
const char* password = "BANANATEAM";
const char* mqtt_server = "riset.revolusi-it.com";
const char* user_mqtt="usm";
const char* pass_mqtt="rahasia234";

// const char* mqtt_server = "riset.revolusi-it.com";
const char* topik = "iot1/G.231.21.0038";
...
void reconnect() {
 ...
 // Attempt to connect
 if (client.connect("G.231.21.0038",user_mqtt,pass_mqtt)) {
